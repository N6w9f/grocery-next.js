...
const NoData = () => {
    return (
        <div className="white_green_selection relative mx-auto my-20 flex max-w-xl flex-col items-center justify-center px-10 py-20">
            <svg
            ...
            <h1 className="mb-6 text-4xl font-black text-white">No Data!</h1>
            <p className="max-w-sm text-lg text-center text-white">
                You might have no orders or data still in the way just wait few
                seconds
            </p>
            {/* <!-- prettier-ignore --> */}
                ...
                >
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop offset="1" stopColor="#16a34aa3" />{" "}
                        </linearGradient>{" "}
                    </defs>{" "}
                </svg>
            </div>
